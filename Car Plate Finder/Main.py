...
def find_Plate(img):
    ...
    img = cv2.imread('./images/car_18.jpg')
    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
    plt.imshow(cv2.cvtColor(gray, cv2.COLOR_BGR2RGB))
    plt.title('Imagem apos convercao para escala de cinza e desfoque')
    plt.show()
    ...
    plt.title('Imagem apos filtro bilateral e convulacao de canny')
    plt.show()
    ...
    if location is None:
        ...
        plt.title('Imagem apos encontrar concornos e aplicacao da mascara')
        plt.show()
        ...
        plt.title('Imagem apos binarizacao')
        plt.show()
        ...
        plt.title('Imagem apos dilatacao')
        plt.show()
        ...
        plt.title('Imagem apos redimensionamento')
        plt.show()
